...
kubectl scale -n $NS0 deploy frontend --replicas=1 --context=$CLUSTER3
...
kubectl scale -n $NS3 deploy checkoutservice --replicas=1 --context=$CLUSTER3
...
kubectl scale -n $NS4 deploy cartservice --replicas=1 --context=$CLUSTER3
...
kubectl scale -n $NS5 deploy paymentservice --replicas=1 --context=$CLUSTER3
...
kubectl scale -n $NS5 deploy shippingservice --replicas=1 --context=$CLUSTER3
...
kubectl scale -n $NS5 deploy currencyservice --replicas=1 --context=$CLUSTER3
