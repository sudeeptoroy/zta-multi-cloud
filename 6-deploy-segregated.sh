...
kubectl scale -n $NS3 deploy paymentservice --replicas=0 --context=$CLUSTER1
kubectl scale -n $NS3 deploy paymentservice --replicas=1 --context=$CLUSTER2

kubectl scale -n $NS1 deploy cartservice --replicas=0 --context=$CLUSTER1
...
kubectl scale -n $NS1 deploy checkoutservice --replicas=0 --context=$CLUSTER2
...
kubectl scale -n $NS1 deploy shippingservice --replicas=0 --context=$CLUSTER2

kubectl scale -n $NS4 deploy adservice --replicas=0 --context=$CLUSTER1
